...
class GameView:
    ...
    # Reescalar a imagem de fundo para se ajustar ao tamanho atual da tela
        fundo_redimensionado = pygame.transform.scale(self.fundo, (self.largura, self.altura))
    # Desenhar a imagem de fundo redimensionada na tela
        self.janela.blit(fundo_redimensionado, (0, 0))

    def atualizar_tamanho(self, largura, altura):
        self.largura = largura
        self.altura = altura
        self.janela = pygame.display.set_mode((largura, altura), pygame.RESIZABLE)
    # Redimensionar o fundo para o novo tamanho da janela
